...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(10); // import $ from 'jquery';
	
	
	var bootstrap = function bootstrap(document) {
	    (0, _calendar2.default)(document.getElementsByClassName('calendar')[0]);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loaded(cacheSize) {
	    myScroll = new _iscroll2.default('#scrollArea', {
	        mouseWheel: true,
	...
	while (day.getTime() <= now) {
	    ...
	    for (var key in week) {
	        cache.push((0, _week2.default)({ line_id: cache.length, days: getWeekArray(week[key].start, week[key].end) }));
	    }
	...
	module.exports = function (el) {
	    ...
	    el.innerHTML = (0, _calendar2.default)({});
	    loaded(cache.length);
...
/***/ function(module, exports) {
	...
	var __t, __p = '';
	__p += '<div id="scrollArea" class="clusterize-scroll">\n    <div id="contentArea" class="clusterize-content">\n    	<div class="list">\n    		<div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n            <div class="calendar--line"></div>\n    	</div>\n	</div>\n</div>\n';
	return __p
	}
...
/***/ function(module, exports) {
	...
	__p += '<div class="calendar--week"  data-line_id=' +
	((__t = (data.line_id)) == null ? '' : __t) +
	'>\n	';
...
/***/ function(module, exports, __webpack_require__) {
	...
	// INSERT POINT: _wheel
		...
		updateCachePartial: function(start, data, update){
			var i, l;
			for ( i = 0, l = data.length; i < l; i++ ) {
				this.infiniteCache[parseInt(start) + i] = data[i];
			}
			if (update) {
